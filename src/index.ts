...
export default class SolarPanelsMap {
  ...
  private async initForm() {
    ...
    autocomplete.addListener("place_changed", () => {
      ...
      if(!place.geometry?.location)
        return alert("Irgendetwas ist schief gelaufen, ich kann den Standort dieser Adresse nicht auflösen!");
      ...
      this.showInsightsForCoordinate({
        ...
        if(error.message.includes("404"))
          alert("Für diese Adresse gibt es leider keinen Versicherungsschutz!");
        else
          alert("Entschuldigung, da ist etwas schief gelaufen!");
      });
    });
  };
  ...
  private initPanel() {
    ...
    panelsCountTitle.innerText = "Anzahl der Module";
    ...
    annualEnergyTitle.innerText = "Jährliche Leistung";
